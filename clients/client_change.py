...
# ── Get a FRESH token right before the PUT ────────────────────────────────────
# Option A: paste a brand new token from https://kg.ebrains.eu (copy it fresh!)
...
# Print full error details instead of just raising
